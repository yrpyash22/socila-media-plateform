// Yeh code check karega ki agar environment variable hai toh wo use kare, 
// warna default Render wale link par chala jaye.
...
const create = async (params, credentials, post) => {
  ...
  let response = await fetch(BASE_URL + '/api/post/'+params.userId,requestOptions)
...
const getFeed = async (params, credentials,signal)=>{
    ...
    let response = await fetch(BASE_URL + '/api/post/feed/'+params.userId,requestOptions)
...
const getFeedUser = async (params, credentials,signal)=>{
    ...
    let response = await fetch(BASE_URL + '/api/post/feedUser/'+params.userId,requestOptions)
...
const remove = async (params, credentials) => {
  try {
    let response = await fetch(BASE_URL + '/api/post/' + params.postId, {
      method: 'DELETE',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const Like =async(params ,credentials, postId  )=>{
  ...
  try {
    ...
    let response = await fetch(BASE_URL + '/api/post/like',
    {
      method :'PUT',
      headers:{
        'Accept': 'application/json',
...
const unlike =async(params ,credentials, postId  )=>{
  ...
  try {
    ...
    let response = await fetch(BASE_URL + '/api/post/unlike',
    {
      method :'PUT',
      headers:{
        'Accept': 'application/json',
...
const comment = async (params, credentials, postId, comment) => {
  try {
    let response = await fetch(BASE_URL + '/api/post/comment/', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const update = async (params, credentials, Values) => {
  let v = {name:"FFF"}
  try {
    let response = await fetch(BASE_URL + '/api/users/update/' + params.userId, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization':credentials.t
...
console.log(params.userId , postId , comment)
  ...
  try {
    let response = await fetch(BASE_URL + '/api/post/uncomment/', {
      method: 'PUT',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const searchuser = async (params, credentials,se) => {
  console.log(se);
  try {
    let response = await fetch(`${BASE_URL}/api/users/?search=${se.search}`, {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const getMessage = async (params, credentials,se) => {
  console.log(se)
  try {
    let response = await fetch(`${BASE_URL}/api/message/${se}`, {
      method: 'Get',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
const setMessage = async (params, credentials,se) => {
  console.log(params)
  try {
    let response = await fetch(`${BASE_URL}/api/message/`, {
      method: 'Post',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
